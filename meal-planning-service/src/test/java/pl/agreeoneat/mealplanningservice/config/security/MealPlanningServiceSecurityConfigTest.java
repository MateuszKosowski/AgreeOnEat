package pl.agreeoneat.mealplanningservice.config.security;
...
import pl.agreeoneat.mealplanningservice.security.KeycloakRealmRoleConverter;
import pl.agreeoneat.mealplanningservice.security.KeycloakRealmRolesExtractor;
import pl.agreeoneat.mealplanningservice.testsupport.SecurityTestController;
...
class MealPlanningServiceSecurityConfigTest {
	...
	@Test
	void acceptsProtectedEndpointForUserRole() throws Exception {
		mockMvc.perform(get("/api/test")
					.with(jwt()
